...
from agenda_google.authenticate import authenticate_google_calendar

def list_gpus_available(service, calendar_id, date=None):
    """Lista as GPUs disponíveis em um determinado dia"""
    if date is None:
    ...
    all_gpus = [f'GPU {i+1}' for i in range(8)]  # Exemplo de 8 GPUs disponíveis
...
if __name__ == '__main__':
    ...
    if available_gpus:
        # Exemplo: Reserva a primeira GPU disponível das 10h às 12h
